/**
 * @file Exerises7-13.cpp
 * @brief 演習7-13	要素数がnである配列bの全要素を配列aにコピーする関数を作成せよ。
...
int main() {
	...
	int copyArray[rowElement];	// コピーした配列

	/* 格納関数呼び出し */
	ary_cpy(copyArray, array, rowElement);

	/* 表示関数呼び出し */
	print2d(copyArray, rowElement);
